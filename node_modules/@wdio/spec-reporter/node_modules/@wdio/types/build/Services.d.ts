...
export interface ServiceClass {
     ...
     */
    shouldRun?(options: WebdriverIO.ServiceOption, capabilities: ResolvedTestrunnerCapabilities, config: WebdriverIOOptions): boolean | Promise<boolean>;
}
export interface ServicePlugin extends ServiceClass {
     ...
     */
    shouldLoad?(config: Omit<TestrunnerOptions, 'capabilities' | keyof HookFunctions>, capabilities: TestrunnerCapabilities): boolean | Promise<boolean>;
}
...
export interface HookFunctions {
     ...
     */
    onWorkerEnd?(cid: string, exitCode: number, specs: string[], retries: number, signal?: NodeJS.Signals | null): unknown | Promise<unknown>;
    /**
